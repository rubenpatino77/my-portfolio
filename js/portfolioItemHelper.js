...
switch(programName) {
	...
	case "My Website Example":
		...
		document.getElementById("item-intro-pic").src = 'img/webIntroPic.png';
		...
		servicesVideo.src =
		  'myPics/mc559ServicesPageVid.mp4';
		...
		customersVideo.src =
		  'myPics/mc559HappyCustomersVid.mp4';
		...
		responsiveVideo.src =
		  'myPics/mc559SmallScreenVid.mp4';
